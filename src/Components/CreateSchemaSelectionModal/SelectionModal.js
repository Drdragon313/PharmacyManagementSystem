          ...
          <Space size={8}>
            <Col span={6}>
              ...
              <Space size={1} direction="vertical">
                <Image className="DBimg" src={databaseImg} preview={false}></Image>
                <h6>Import from Database</h6>
              <p>This method will allow users to connect to their existence database to import their desired schema.</p>
              </Space>
              </CustomCard>
            </Col>
            <Col span={6} onClick={openSchemaCreationForm}>
              ...
              <Space size={1} direction="vertical">
              <Image className="manualImg" src={manulaImg} preview={false}></Image>
              <h6>Import Manually</h6>
              <p>Using this method user will upload the entire schema manually by adding each field and validation individually.</p>
              </Space>
              </CustomCard>
            </Col>
            <Col span={6}>
             <Link to="/schema/autopopulate">
              <CustomCard className="importfromCSV">
              <Space size={1} direction="vertical">
              <Image className="csvImg" src={CSVimg} preview={false}></Image>
              <h6>Import from CSV</h6>
              <p>This method will allow users to import there schema by importing file.</p>
              </Space>
              </CustomCard>
              </Link>
            </Col>
